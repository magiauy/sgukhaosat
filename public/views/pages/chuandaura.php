...
<section class="hero hero-quytrinh">
    <div class="hero-content">
        <h1>Quy Trình Cập Nhật Chuẩn Đầu Ra</h1>
        <p class="lead mb-4">Các tài liệu liên quan đến quy trình cập nhật chuẩn đầu ra của Đại học Sài Gòn</p>
    </div>
</section>
...
<div class="container">
    ...
    <nav aria-label="breadcrumb" class="mt-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Quy Trình Cập Nhật Chuẩn Đầu Ra</li>
        </ol>
    </nav>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">Tài Liệu Quy Trình Cập Nhật Chuẩn Đầu Ra</h5>
                </div>
                <div class="card-body">
