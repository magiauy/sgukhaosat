<div class="container mt-4">
    ...
    <div class="d-flex flex-grow-1">
        ...
        <button class="btn btn-outline-primary ms-2" id="fTypeSearchBtn">Lọc</button>
    </div>
    
    <div class="action-buttons ms-auto d-flex gap-2">
        <button class="btn btn-outline-danger" id="fTypeDeleteBtn">
            <i class="bi bi-trash"></i> Xóa
        </button>
        <button class="btn btn-outline-primary" id="fTypeAddBtn">
