...
<div class="container mt-4">
    ...
    <div class="mb-3" id="majorIDGroup">
        ...
        <input type="text" id="majorID" class="form-control" required>
    </div>

    <div class="mb-3">
        <label for="majorName" class="form-label">Tên ngành</label>
        <input type="text" id="majorName" class="form-control" required>
    </div>

    <button type="button" class="btn btn-primary" id="majorActionBtn"></button>
    <a href="#" class="btn btn-secondary ms-2" onclick="navigateToMajorList()">Quay lại</a>
</div>
</body>
</html>
